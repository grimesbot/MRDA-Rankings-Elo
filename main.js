...
function calculateAndDisplayRankings() {
    ...
    if (mrdaEloRatingSystem.absoluteLogErrors.length > 0)
    {
        ...
        if (mrdaEloRatingSystem.absoluteLogErrors_2025_Q4.length > 0)
            $pctErrorDiv.append("2025 Q4: " + meanAbsoluteLogErrorPercent(mrdaEloRatingSystem.absoluteLogErrors_2025_Q4) + "<br />");        
